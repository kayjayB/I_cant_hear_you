...
\begin{itemize}
	...
	\item Sub-phase 3: Attack and release times for changing the gain per frequency range 
...
The first two sub-phases will be implemented concurrently with phase 4 by Kayla-Jade. 
