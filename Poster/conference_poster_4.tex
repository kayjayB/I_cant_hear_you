...
The error in the directionality feature was calculated by comparing the measured and the simulated polar plots for each steerable angle
\begin{center}
...
\begin{itemize}\compresslist
	...
	\item Emdedding the microphones and circuitry into a pair of headphone to reduce the size of the device
\end{itemize}
}
...
The simulation results are depicted through a comparison of the original and compensated frequency spectra from a single frame of recorded voice audio.
