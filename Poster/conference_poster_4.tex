...
\begin{center}
	\includegraphics[width=0.6\linewidth]{directionalityLabTest.png}
...
\vspace{1em}
\begin{center}
	\includegraphics[width=0.7\linewidth]{fftSoftware.png}
	\captionof{figure}{FFT Software}
\end{center}

\begin{center}
	\includegraphics[width=0.7\linewidth]{polar90degSoftware.png}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{deg0hardware.png}
	\captionof{figure}{${0}^o$ }
\end{center}

\begin{center}
	\includegraphics[width=0.7\linewidth]{deg60hardware.png}
...
\begin{multicols}{2}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{deg90hardware.png}
		\captionof{figure}{${90}^o$ }
	\end{center}
	
	\begin{center}
		\includegraphics[width=0.7\linewidth]{audiogram.png}
