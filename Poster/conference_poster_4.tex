...
\begin{itemize}\compresslist
	\vspace{-0.7em}
	\item Filter bank: 16 \nth{14} order band pass filters with a $\frac{1}{3}$ octave bandwidth
	\item System bandwidth = 250~Hz to 8000~Hz
\end{itemize}

{\large \textbf{Hardware Hearing Aid}}
\begin{center}
	\includegraphics[width=1\linewidth]{posterBlockDiagram.pdf}
	\captionof{figure}{Block diagram of the hardware hearing aid}
\end{center}
\begin{itemize}\compresslist
	\vspace{-0.7em}
	\item Filter bank: 2 second order band pass filters
\end{itemize}
