...
The error in the directionality feature was calculated by comparing the measured to the simulated polar plots for each steerable angle. Compensatory gain error was calculated using the difference between the desired and measured gain at the centre of each frequency band.
\begin{center}
...
{\large \textbf{Testing}}
\begin{center}
	\includegraphics[width=0.3\linewidth]{directionalityLabTest.png}
...
The simulation results are depicted through a comparison of the original and compensated frequency spectra from a single frame of recorded voice audio. The polar plot shows the normalized gain of the simulated microphone array when the dial is facing $90^{o}$.
...
\end{center}
	\begin{center}
	\includegraphics[width=0.4\linewidth]{polar90degSoftware.png}
