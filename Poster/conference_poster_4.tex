...
{\bf\textsc{An investigational study into the design of a low cost, adaptive hearing aid}\vspace{0.5em}} % Poster title
...
\headerbox{Acknowledgements}{name=acknowledgements,column=3,aligned=references,above=bottom}{ % This block is as tall as the references block
...
\headerbox{Methodology}{name=method,column=0,below=introduction}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{Conclusion}{name=conclusion,column=3,below=FutureWork,bottomaligned=method}{ % This block's bottom aligns with the bottom of the conclusion block
