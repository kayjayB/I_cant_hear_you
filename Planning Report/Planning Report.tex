...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\abstract{Presented in this paper, is the project plan for the design and implementation of an adpative hearing aid. The developed hearing aid device is required to provide compensatory gain independently for each ear in accordance with an individuals audiogram. Additionally, the device is required to have a directionality feature that is manually tuneable by the user. The final essential component is the testing of the device, specifically through laboratory and clinical testing. The justified design choices of all components are detailed. All features of the hearing aid device will be implemented using MATLAB and Simulink software and will make use of an Arduino Due microcontroller. In managing the project until the deadline, it was found that it was best to divide the project into 11 phases. Certain phases will be completed separately by each group member while others will be performed together. A Gantt chart is included to represent the time management and work division of the group. The identification of potential project risks is made and the relevant mitigation actions are discussed. Finally, a cost analysis is included and it is expected that the project will cost approximately R1528. }
