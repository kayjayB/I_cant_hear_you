...
\begin{itemize}\compresslist
	\vspace{-0.4em}
	\item Amplifying specific frequency bands according to a person's audiogram
	\item The ability of the user to select the direction in which they wish to listen and to hear sounds in that direction louder than other directions \cite{Evaluation_of_a_hearing_compensation_algorithm}
\end{itemize}
...
\headerbox{Results: Hardware}{name=results3,column=2,row=0}{
	...
	\begin{center}
		...
		\resizebox{0.5\columnwidth}{!}{%
			\begin{tabular}{cc}
				\toprule
				\textbf{Frequency band (Hz)} &\textbf{Error (\%)} \\ 
				\midrule
				2820 - 3550 & 0.81 \\ 
				5620 - 7080 & 19.56 \\ 
				\bottomrule
...
\begin{itemize}\compresslist
	...
	\item Steering the acoustic beam to attenuate directions other than the selected one (by making use of array theory)
